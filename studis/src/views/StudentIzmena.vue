...
const fetchStudent = async () => {
  try {
    ...
    brojIndeksa.value = response.data.student.broj_indeksa;
    ime.value = response.data.student.ime;
    prezime.value = response.data.student.prezime;
    imeRoditelja.value = response.data.student.ime_roditelja;
    email.value = response.data.student.email;
    telefon.value = response.data.student.broj_telefona;
    godinaStudija.value = response.data.student.godina_studija;
    datumRodjenja.value = new Date(response.data.student.datum_rodjenja)
      .toISOString()
      .split("T")[0];
    jmbg.value = response.data.student.jmbg;
  } catch (error) {
...
const handleSubmit = async (event) => {
  ...
  try {
    const response = await axios.put(`/api/student-izmena/${id}`, {
...
<template>
  <FormContainer title="Izmena studenta">
